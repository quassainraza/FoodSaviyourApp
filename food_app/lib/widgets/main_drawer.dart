...
import 'package:food_app/screens/profile_receiver.dart';
...
class MainDrawer extends StatelessWidget {
  ...
  Widget buildListTile(String title, void Function()?  tapHandler, Icon symbol) {
    return ListTile(
      leading: symbol,
      title: Text(title),
      onTap: tapHandler,
            ...
            child: ListTile(
              ...
              onTap: () {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => ProfileReceiver()),
                );
