                                    ...
                                    child: isLoading
                                        ...
                                        : Container(
                                            child: ListView.builder(
                                                ...
                                                itemBuilder: (ctx, i) {
                                                  if (documents == null) {
                                                    // Handle the case where documents is null
                                                    return Container(); // You can return an empty container or a loading widget
                                                  }
                                                  ...
                                                  if (timestamp == null) {
                                                    // Handle the case where the 'date' field is null
                                                    return Container(); // You can return an empty container or a loading widget
                                                  }

                                                  DateTime date2 = timestamp.toDate();

                                                  if (date2.isBefore(DateTime.now())) {
                                                    Firestore.collection('orders').doc(documents[i]['id']).delete();
                                                  }
