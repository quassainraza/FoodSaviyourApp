                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          'This Terms and Conditions Agreement sets forth the standards of use of the Food Donation service, (“Food Saviyour Pvt.Ltd”) Online Service. By using the Food Saviyour app, you (the ”User”) agree to these terms and conditions. If you do not agree to the terms and conditions of this Agreement, you should immediately cease all usage of this application. We reserve the right, at any time, to modify, alter, or update the terms and conditions of this agreement without prior notice. Modifications shall become effective immediately upon being posted at Food Saviyour Application. Your continued use of the Service after amendments are posted constitutes acknowledgement and acceptance of the Agreement and its modifications. Except as provided in this paragraph, this Agreement may not be amended.'),
                      ...
                      Text(
                          '3.5.   We reserve the right to suspend or terminate your Food Saviyour Application Account and your access to the Services if any information provided during the registration process or thereafter provided is inaccurate, not current or incomplete.'),
                      Divider(color: Colors.black),
                      Padding(
                        padding: EdgeInsets.all(20),
                      ...
                      Text(
                          '5.2.   If you fail to pick up the Food at the time they are ready for pick up then all risk and responsibility in relation to such Food shall pass to you. And you shall be removed from Food Saviyour in the future.'),
                      Text(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      onPrimary: Colors.pink, // Set the splash color
                    ),
                  ),
